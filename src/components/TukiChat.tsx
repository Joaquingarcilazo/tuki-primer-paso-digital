...
const questions = [
  {
    id: 'productoServicio',
    text: '¿Qué tipo de producto o servicio ofrecés? Brindame detalles para ayudarte mejor 😊',
  ...
  const startOnboarding = () => {
    ...
    setTimeout(() => {
      ...
      const welcomeMessage: Message = {
        ...
        text: 'Trabajaré 24/7 creando campañas efectivas de marketing digital para tu negocio.',
        isBot: true,
        timestamp: new Date()
      };
