...
const questions = [
  {
    id: 'productoServicio',
    text: 'Para empezar dame algunos detalles... 😊 ¿Qué tipo de producto o servicio ofrecés?',
  ...
  {
    id: 'nivelAdquisitivo',
    text: 'Genial. ¿Qué niveles adquisitivos tienen? Podés seleccionar todas las opciones que apliquen 💰',
    type: 'multiple',
...
const TukiChat: React.FC = () => {
  ...
  const startOnboarding = () => {
    ...
    // Después de 1 segundos, ocultar el saludo inicial y mostrar el mensaje de bienvenida
    setTimeout(() => {
      setShowInitialGreeting(false);
      
      const welcomeMessage: Message = {
        id: 'welcome-' + Date.now() + '-' + Math.random(),
        text: 'Durante un mes estaré 24/7 creando campañas efectivas de marketing digital para tu negocio. Gratis!!!',
        isBot: true,
        timestamp: new Date()
      };
